...
4. Uses in proper way all site facilities such as: buttons, inputs, navbar tabs, slider, alert announcement, search area for searching desirable products, buttons for translating Application content, to make a subscription for newsletters etc.
