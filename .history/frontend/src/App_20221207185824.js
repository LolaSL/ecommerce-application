        ...
        >
          <Nav className="flex-column text-white w-100 pt-4">
            <Nav.Item className="m-3 ">
              <Button url="https://linkedin.com" className="me-2 btn-linkedin" style={{ height: 25, width: 25 }} />
              Linkedin
            </Nav.Item>
            <Nav.Item className="m-3 ">
              <Button url="https://github.com/" className="me-2 btn-linkedin" style={{ height: 25, width: 25}} />
              Github
            </Nav.Item>
