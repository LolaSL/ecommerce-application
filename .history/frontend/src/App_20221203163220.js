  ...
  return (
    <BrowserRouter>
      <div className="d-flex flex-column site-container">
        ...
        <header className="header">
          <Navbar className="navbar nav" bg="dark" variant="dark" expand="lg">
            <Container className="container">
              ...
              <Link className="link" to="/shop" rel="noopener noreferrer">
                Arts Shop
              </Link>
        ...
        {/* <FooterComponent /> */}
        <footer className=" footer text-center fw-bold d-flex">
        <span className="p-2 text-black">© 2023 Copyright: </span>
      <Link to="/#" className="m-3 text-black a-link">
        {" "}
        Arts Shop
      </Link>
        </footer>
