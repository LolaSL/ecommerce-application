...
import  LinkContainer  from 'react-router-bootstrap/Li';
      ...
      >
          ...
          <Nav className="flex-column text-white w-100 p-2">
            ...
            {categories.map((category) => (
              <Nav.Item key={category}>
                ...
                >
                  <Nav.Link className="nav-link">{category}</Nav.Link>
                  </LinkContainer>
              </Nav.Item>
            ))}
          </Nav>
        ...
        <footer className="footer text-center fw-bold">
          {/* <span className="p-2 text-black ">
            ...
            <h6 className="m-3 text-black">© 2023 Copyright: Arts Shop</h6>
          </span> */}
        </footer>
      </div>
    </BrowserRouter>
