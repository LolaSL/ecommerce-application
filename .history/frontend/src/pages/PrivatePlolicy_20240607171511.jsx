    ...
    <div>
      ...
      <div className="site-container">
        ...
        <article className="private_policy">
          <h2>ADVERTISING</h2>
          <p>
          As described above, we use your Personal Information to provide you with advertisements or marketing communications we believe may be of interest to you.
          </p>
        </article>
        <article className="private_policy">
