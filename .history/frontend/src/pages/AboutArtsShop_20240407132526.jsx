...
const AboutArtsShop = () => {
  return (
    ...
    </div>We celebrate local artists and acknowledge the significant duty we have to uphold the Galleries’ heritage, which includes maintaining the collection for posterity. In orchestrating our operations, we prioritize our audience’s preferences. We are proactive in pursuing collaborative ventures with various entities and gifted individuals across community, national, and global stages, ensuring our initiatives, releases, and gatherings are varied, high-quality, and pertinent.
  );
};
