    ...
    <div>
      ...
      <div className="site-container">
        <article className="terms-of-service">
          <h1 className="text-center mb-2 py-4 fw-bold">Terms of Service</h1>
          <h4 className="text-center mb-2 py-4">Overview</h4>
          <p>
            This website is operated by Arts Shop. Throughout the site, the
            terms “we”, “us” and “our” refer to Arts Shop. Arts Shop offers this
            website, including all information, tools and services available
            from this site, to you the user, conditional upon your acceptance of
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 1 - ONLINE STORE TERMS</h4>
          <p>
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 2 - GENERAL CONDITIONS</h4>
          <p>
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">
          ...
          <p>
            ...
            material on this site is at your own risk. This site may contain
            ...
            have no obligation to update any information on our site. You agree
            that it is your responsibility to monitor changes to our site.
          </p>
        </article>
        <article>
          <h4 className="text-center mb-2 py-4">SECTION 4 - MODIFICATIONS TO PRICES</h4>
          <p>
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 5 - PRODUCTS</h4>
          <p>
            ...
            product made on this site is void where prohibited. We do not
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h4>
          <p>
            ...
            distributors. For more details, please review our Returns Policy{" "}
            <strong>
              {" "}
              <i><Link to="/returns" className="link_to_returns">here:</Link></i>
            </strong>
          </p>
        </article>
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 7 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h4>
          <p>
            ...
            someone other than yourself, or otherwise mislead us or third-party
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 8 - PERSONAL INFORMATION</h4>
          <p>
            Your submission of personal information through the store is
            governed by our Privacy Policy. To view our Privacy Policy, click
            <strong>
              {" "}
              <i><Link to="/private_policy" className="link_to_private_policy"> here:</Link></i>
            </strong>
          </p>
        </article>
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 9 - ERRORS, INACCURACIES AND OMISSIONS</h4>
          <p>
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 10 - PROHIBITED USES</h4>
          <p>
        ...
        <article className="terms-of-service">
          ...
          <p>
            ...
            the service will be accurate or reliable. You expressly agree that
            your use of, or inability to use, the service is at your sole risk.
            In no case shall Arts Shop, our director, employees, contractors,
            interns, suppliers, or service providers or be liable for any
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 12 - INDEMNIFICATION</h4>
          <p>
            You agree to indemnify, defend, and hold harmless Arts Shop, and our
            directors, contractors, service providers, subcontractors,
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 13 - ENTIRE AGREEMENT</h4>
          <p>
        ...
        <article className="terms-of-service">
          <h4 className="text-center mb-2 py-4">SECTION 14 - CHANGES TO TERMS OF SERVICE</h4>
          <p>
