    ...
    <div>
      ...
      <div>
        <div className="site-container">
          <article>
            <h1 className="justify-content-center pt-4">Arts Shop Mission</h1>
            ...
            <p className="arts_shop_about_paragraph bold pt-4" style={{textAalign: "justify"}}>
          ...
          <article>
            <h2 className="justify-content-center pt-4">Arts Shop Goal</h2>
            <ul>
              <li>
