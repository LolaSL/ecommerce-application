  ...
  return (
    <div>
      ...
      <div className="site-container">
        ...
        <article className="private_policy">
          <h3 className="text-center mb-2 py-4">DISCLOSING YOUR PERSONAL INFORMATION</h3>
          <p>
        ...
        <article className="private_policy">
          <h3 className="text-center mb-2 py-4">ADVERTISING</h3>
          <p>
        ...
        <article className="private_policy">
          <h3 className="text-center mb-2 py-4">DO NOT TRACK</h3>
          <p>
        ...
        <article className="private_policy">
          <h3 className="text-center mb-2 py-4">DATA RETENTION</h3>
          <p>
