        ...
        <article className="private_policy">
          ...
          <p>
            ...
            sale items cannot be refunded.
                  ...
                  <p>
                  Exchanges We replace items if they are defective or damaged and we pay for the shipping. If you need to exchange it for the same item, send us an email at trish@artshop.space  
                  </p>
        </article>
      </div>
    </div>
