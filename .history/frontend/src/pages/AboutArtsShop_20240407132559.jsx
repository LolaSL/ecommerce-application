        ...
        <div className="site-container">
          ...
          <article>
            ...
            <ol>
              <li>Inspiration.</li>
              <li>Pride.</li>
              <p>We celebrate local artists and acknowledge the significant duty we have to uphold the Galleries’ heritage, which includes maintaining the collection for posterity.</p>
