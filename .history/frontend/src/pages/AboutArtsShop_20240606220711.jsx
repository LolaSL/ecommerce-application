...
import aboutImage from '../assets/21.jpg';
const AboutArtsShop = () => {
  return (
    <div>
      <Helmet>
      ...
      <div>
        <div className="site-container" style={{ backgroundImage: `url(${ aboutImage})`,    backgroundRepeat: "no-repead",  backgroundSize: "cover" }}>
