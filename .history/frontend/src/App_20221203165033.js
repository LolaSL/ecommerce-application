      ...
      <div className="d-flex flex-column site-container">
        ...
        <footer className=" footer text-center fw-bold ">
          <span className="p-2 text-black ">
            <Link to="https://github.com" className="m-3 text-black a-link">© 2023 Copyright: Arts Shop</Link>
            <Link to="https://linkedin.com" className="m-3 text-black a-link">© 2023 Copyright: Arts Shop</Link>
