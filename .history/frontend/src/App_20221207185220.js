        ...
        >
          <Nav className="flex-column text-white w-100 pt-4">
            {/* <Nav.Item className="mb-2">
              <SocialIcon url="https://linkedin.com" className="me-2 pr-2" style={{ height: 25, width: 25 }} />
              Linkedin
            </Nav.Item> */}
            <Link to="https://linkedin.com"></Link>
            <Nav.Item className="mb-2">
              <SocialIcon url="https://www.github.com/" className="me-2 " style={{ height: 25, width: 25, color:"white" }} />
              Github
            </Nav.Item>
