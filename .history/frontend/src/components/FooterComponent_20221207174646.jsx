  ...
  return (
    <footer className="footer bg-dark text-center text-white pt-2">
      <div class="footer-content">
        <ul class="socials">
        <SocialIcon url="https://www.guthub.com/in/jaketrent" label="my portfolio" className="me-2 small-icons"/>
          <SocialIcon url="https://linkedin.com/in/jaketrent" className="me-2 small-icons" />
