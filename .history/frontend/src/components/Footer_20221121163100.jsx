const Footer = () => {
    return (
      <footer className="footer  navbar-fixed-bottom justify-content-center p-4 mb-0">
        ...
        <div className="m-2 text-center">
          <a href="https://linkedin.com">
            <span className="p-2 ">
              <i className=" fa-linkedin-square text-dark" aria-hidden="true">
        ...
        <div className="m-2 text-center">
          <span className="p-2">
            <i className="fa fa-copyright text-dark" aria-hidden="true">
