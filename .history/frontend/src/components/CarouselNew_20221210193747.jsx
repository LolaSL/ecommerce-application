  ...
  return (
    ...
    <Carousel className="carousel mt-4 mb-4">
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h1 className="product-title fw-bold  text-danger">Bohemian Glass Vase</h1>
          <p className="title fw-bold  text-warning">Glass vase is decorated in a stained glass window style ...</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h1 className="product-title  fw-bold text-danger">Egyptian Gods</h1>
