      ...
      <div>
        <article>
          ...
          <p>
            ...
            quality workshops taught by professional artists. Most recently,
            we’ve partnered with local organizations such as Boys & Girls Clubs
            of Weber-Davis, Youth Impact, YCC Family Crisis Center, The Monarch,
            Utah Division of Arts & Museums, Utah Division of Multicultural
            Affairs, and the Weber Valley Youth Center. Our teaching artists
            develop lesson plans that engage media across artistic disciplines
            including photography, videography, painting, drawing, printmaking,
            performance art, new genres, and more. Research shows that students
            who participate in extracurricular arts programs volunteer more
            within their community, maintain higher grades across all subjects,
            and are more likely to attend college compared to peers who do not
            participate in extracurricular arts programs. By expanding our
            youths’ skills, knowledge, and confidence in an array of art forms
            and providing community platforms for them to showcase their
            talents, we believe that partnering with local organizations helps
            our youth achieve success at school, home, and beyond. To learn more
            about bringing OCA Artist Factory to your organization please
            contact our program coordinator Kasey Lindley at
            kasey@ogdencontemporaryarts.org. Are you interested in teaching
            youth workshops for OCA? Send us your resume!
          </p>
        </article>
      </div>
    </div>
