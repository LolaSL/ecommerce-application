    ...
    <Carousel className="carousel mt-4 mb-4">
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="title fw-bold  text-danger">Great colors and elegant look, good choice for wall decor...</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="title  fw-bold text-warning">Museum quality collectible home decor figurine...</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="title  fw-bold  text-warning">Handmade 1950s-style sunburst clock.</p>
        </Carousel.Caption>
      </Carousel.Item>
      </Carousel>
    </Container>
