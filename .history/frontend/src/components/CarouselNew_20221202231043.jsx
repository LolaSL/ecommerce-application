  ...
  return (
    ...
    <Carousel className="carousel mt-4 mb-4">
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h1 className="product-title fw-bold">Bastet Goddess</h1>
          <p className="title fw-bold">Cold cast silver color Egyptian Cat Bastet statue for home decor.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h1 className="product-title  fw-bold">Diamond Bracelet</h1>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h1 className="product-title  fw-bold">Cerries</h1>
          <p className="title  fw-bold text-wi">This unique and original contemporary artwork 'Cherries'.</p>
        </Carousel.Caption>
      </Carousel.Item>
      </Carousel>
    </Container>
