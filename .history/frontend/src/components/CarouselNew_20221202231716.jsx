...
function CarouselNew() {
  return (
    <Container className="container middle-container mt-4 mb-4">
      <h1 className="text-center m"> New Arrivals</h1>
    <Carousel className="carousel mt-4 mb-4">
      <Carousel.Item>
        <img className="d-block w-100 rounded shadow border py-4" src="/images/3.jpg" alt="First slide" />
        <Carousel.Caption>
          <h1 className="product-title fw-bold  text-success">Bastet Goddess</h1>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h1 className="product-title  fw-bold  text-success">Cerries</h1>
          <p className="title  fw-bold  text-success">This unique and original contemporary artwork 'Cherries'.</p>
        </Carousel.Caption>
      </Carousel.Item>
      </Carousel>
    </Container>
