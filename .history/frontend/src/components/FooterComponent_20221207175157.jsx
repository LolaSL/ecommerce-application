  ...
  return (
    <footer className="footer bg-dark text-center text-white pt-2">
      <div class="footer-content">
        <ul class="socials">
        <SocialIcons  alt="github" network="github" className="me-2" style={{ height: 25, width: 25 }}/>
          <SocialIcons url="https://linkedin.com/in/jaketrent" className="me-2 " style={{ height: 25, width: 25 }} />
