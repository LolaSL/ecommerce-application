    ...
    <footer className="footer bg-dark text-center text-white pt-2">
      <div class="footer-content">
        <ul class="socials">
          ...
          <Container className="rights py-2" style={{ color: 'white', textAlign: 'center' }}>
                    &copy; {new Date().getFullYear()} Copyright:  Lolita Restaurant.  All Rights Reserved
                </Container>
          <Link to="/#" className="m-3 text-white a-link">
            {" "}
            New Arrivals  
          </Link><Link to="/shop" className="m-3 text-white a-link">Arts Shop</Link>
        </ul>
      </div>
    </footer>
  );
