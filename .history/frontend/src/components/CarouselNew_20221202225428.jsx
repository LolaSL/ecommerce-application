      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p className="product-title text-secondary ">Bastet Goddess</p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img
          ...
          <Carousel.Caption>
            <h1 className="product-title text-secondary ">New Arrivals</h1>
            <p className="product-title text-secondary ">Diamond Bracelet</p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img
          ...
          <Carousel.Caption>
            <h1 className="product-title text-secondary ">New Arrivals</h1>
            <p className="product-title text-secondary ">
            Cerries
            </p>
          </Carousel.Caption>
        </Carousel.Item>
