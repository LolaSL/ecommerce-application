...
function App() {
  ...
  return (
    <BrowserRouter>
        ...
        <div PayPalScriptProvider deferLoading={true} options={{"client-id": "AWZuxUdbnw9n6oTMvRzPpPUlzosk58NW9EeRtu1rO2bOP0VVeiQojtisLfqH2oGFm355k-qcjfVODZJC"}}> 
          <App />
        ...
        </Container>  </ PayPalScriptProvider > 
        {/* <Footer /> */}
