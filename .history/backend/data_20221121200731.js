const data = {
    productList: [
        ...
        {
            name: "Nude seated woman",
            slug: "nude-seated-woman",
            category: "Bangle Bracelets",
            image: "/images/9.jpg",
            price: 2790.75,
            countInStock: 4,
            brand: "Robert Ullmann",
            raiting: 4.5,
            numReviews: 57,
            description: "The nude female figure seated with one knee raised and head turned to one side, ht. 12.6'' - 32.1 cm."
        }
    ]
}
export default data;