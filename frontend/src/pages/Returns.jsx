      ...
      <div className="site-container">
        <article className="private_policy">
          ...
          <p>
            ...
            send us an email at arts_shop_returns@example.com
          </p>
          <p>
            Return shipping To return your item mail it to:{" "}
            <strong>
              {" "}
             <i>Apt. 761 25330 Kenton Throughway, Rosarioland, FL 58781-9632.</i> 
            </strong>{" "}
            You'll be responsible for paying for your shipping costs for
            ...
            your exchanged product to reach you, may vary. If you are shipping
