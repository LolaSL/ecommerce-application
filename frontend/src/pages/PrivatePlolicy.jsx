  ...
  return (
    <div>
      ...
      <div className="site-container">
        ...
        <article className="private_policy">
          <h4 className="text-center mb-2 py-4">CHANGES</h4>
          <p>
          We may update this privacy policy from time to time in order to reflect, for example, changes to our practices or for other operational, legal or regulatory reasons.
          </p>
        </article>
        <article className="private_policy">
          <h4 className="text-center mb-2 py-4">CONTACT US</h4>
          <p>
          For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at arts_shop_private_policy@example.com
          </p>
        </article>
      </div>
    </div>
