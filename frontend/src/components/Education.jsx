...
const Education = () => {
  return (
    <div>
      ...
      <div className="arts_education">
        <article>
          <h2 className="text-center mb-2 py-3 fw-bold">WHAT IS ARTS SHOP EDUCATION?</h2>
          <p className="education_paragraph_1 pt-4">
            The Arts Shop hosts and administers a comprehensive schedule of
            ...
            contact us by email: arts_shop_education@example.com.
